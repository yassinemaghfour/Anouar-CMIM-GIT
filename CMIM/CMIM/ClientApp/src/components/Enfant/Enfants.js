...
const rows = [
  ...
  { id: 'datevs ', numeric: true, disablePadding: false, label: 'Date VS' },
...
class EnhancedTableToolbar extends React.Component  {
  render(){
  const { numSelected, classes,open } = this.props;
    ...
    >
      ...
      <div className={classes.actions}>
        {numSelected > 0 ? (
          ...
          <Tooltip title="Ajoute nouveau Enfant">
          
            <IconButton aria-label="Ajouter" onClick={open} >
              <AddtIcon />
            </IconButton>
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <EnhancedTableToolbar numSelected={selected.length} open={this.openForm.bind(this)} />
          ...
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            <TableBody>
              {stableSort(data, getSorting(order, orderBy))
                ...
                .map(n => {
                  const isSelected = this.isSelected(n.enfantId);
                  return (
                    <TableRow
                      hover
                      onClick={event => this.handleClick(event, n.enfantId)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{this.formatDate(n.dateVs)}</TableCell>
                      <TableCell align="left">
                        <Link to={{pathname:'/Enfant/'+n.enfantId}}>
        ...
        aria-labelledby="simple-modal-title"
          ...
          <Paper style={{width:"80%",position:"absolute",left:"10%",top:"15%"}}>
              ...
              <EnfantForm />
              {/* {setToList={this.loadData.bind(this)}} */}
              <div>
...
export default withAuth(withStyles(styles)(Enfant));
