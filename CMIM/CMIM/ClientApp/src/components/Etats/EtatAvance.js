...
class EnhancedTable1 extends React.Component {
  ...
  handlefiltreClick = (event) => {
    axios.get("api/EtatAvance/" + this.state.societe + "/" + this.state.activityPlace)
    .then(res => {
      if(res.status == 200)
      {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <Link to={{pathname:'/EtatAvance/'+n.matricule,state:{matricule:n.matricule,lname:n.last_name,fname:n.first_name,adresse:n.adresse,bu:n.bu,update:false,add:false}}}>
...
export default withStyles(styles)(EnhancedTable1);
